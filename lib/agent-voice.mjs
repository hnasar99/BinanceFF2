const FEMALE = /female|woman|girl|samantha|victoria|karen|moira|fiona|tessa|zira|susan|hazel|allison|ava|kate|olivia|emily|joanna|ivy|kendra|salli|amy|emma|jenny|aria|sonia|libby|natasha|catherine|martha|linda|siri|paulina|monica|pilar|sabina|elena|carmen|google us english female|microsoft zira|microsoft jenny/i;
const MALE = /male|man|boy|david|daniel|alex|fred|tom|mark|james|george|brian|matthew|justin|joey|eric|guy|ryan|nathan|christopher|richard|thomas|oliver|arthur|diego|jorge|pablo|juan|google us english male|microsoft david|microsoft guy/i;
...
export function cannedVoiceSrc(agentId, text) {
...
export function voiceProfile(agentId) {
  return AGENT_VOICES[agentId] ?? AGENT_VOICES.scout;
}
